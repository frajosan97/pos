                        ...
                        <div class="tab-pane fade py-3 show active" id="bio-data-tab-pane" role="tabpanel" aria-labelledby="bio-data-tab" tabindex="0">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="commission_rate" name="commission_rate" value="{{ old('commission_rate', $user->commission_rate) }}" placeholder="Commision Rate in percentage (%)" required />
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-12 border-start border-end border-bottom pt-2">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                @case('manager_branch')
                                                <div class="branch-select" {{ $user->permissions->contains($permission->id) ? 'd-block' : 'd-none' }}>
                                                ...
                                                <div class="catalogue-select" {{ $user->permissions->contains($permission->id) ? 'd-block' : 'd-none' }}>
                                                ...
                                                <div class="product-select" {{ $user->permissions->contains($permission->id) ? 'd-block' : 'd-none' }}>
